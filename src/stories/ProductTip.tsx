  ...
  return (
    <div className="tw-my-8 lg:tw-grid lg:tw-grid-cols-12">
      ...
      >
        ...
        <p className="tw-mt-4 tw-font-body tw-text-headline tw-text-black md:tw-hidden">
          {headline}
        </p>
        <p className="tw-mt-4 tw-font-body tw-text-quote tw-italic  tw-text-black md:tw-mt-6">
          "{children}"
        </p>
      </blockquote>
    </div>
